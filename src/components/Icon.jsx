...
const icons = {
  ...
  bug: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 8v8m-3-5l3 5m-6-5l3 5m-6-5l3 5M9 4l.8 2.2M15 4l-.8 2.2M12 2v2.2M4.5 8.5l1.4-1.4M19.5 8.5l-1.4-1.4" />
    </svg>
  ),
  'arrow-up': (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
function Icon({ name, className }) {
  ...
  if (!IconSvg) {
    // Return a default placeholder or null if the icon name is not found
