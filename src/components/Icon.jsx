...
const icons = {
  ...
  'layout-editor': (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 11.25a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-4.5 0v2.25a2.25 2.25 0 002.25 2.25zM14.25 9.75L12 12l-2.25-2.25" />
    </svg>
  )
};
