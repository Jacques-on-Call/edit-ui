    ...
    <div className="head-editor-overlay">
      <div className="head-editor-modal">
        <div className="head-editor-header">
          <h3>Search Preview & Page Settings</h3>
        ...
        <div className="head-editor-content">
          <div className="form-section">
            <div className="form-group">
                ...
                />
                <span className={`char-counter ${title.length > TITLE_MAX_LENGTH ? 'over-limit' : ''}`}>
            ...
            <div className="form-group">
                ...
                <textarea
                  ...
                  rows="4"
                  maxLength={DESC_MAX_LENGTH + 20}
                />
                <span className={`char-counter ${description.length > DESC_MAX_LENGTH ? 'over-limit' : ''}`}>
                ...
                {(sections || []).map((section, index) => (
                    <div className="section-settings-item" key={index}>
                        ...
                        <input
                            type="text"
                            value={section.type}
                            onChange={(e) => handleSectionFieldChange(index, 'type', e.target.value)}
                        />
