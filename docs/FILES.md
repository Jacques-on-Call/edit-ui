...
| **`easy-seo/src/components/FloatingToolbar.jsx`** | **Contextual Text Formatting Toolbar:** A toolbar that appears above selected text, providing inline formatting options. | Replaces the old `EditorHeader.jsx`. |
